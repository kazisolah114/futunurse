...
const Hero = () => {
    return (
        <div className='flex flex-col items-center justify-center text-center h-[calc(100vh-4rem)] px-96'>
            ...
            <p className='text-lg text-gray-700'>Transform your nursing education with our intelligent Care Plan Assistant and NCLEX Smart Coach. Reduce study time by 70% while improving your clinical skills.</p>
