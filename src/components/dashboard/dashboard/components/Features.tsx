...
const Features = () => {
    return (
        <div className='col-span-2 max-md:col-span-full grid sm:grid-cols-2 gap-4 max-sm:gap-2'>
            <div className='cursor-pointer bg-white/90 hover:bg-white border border-gray-200/50 hover:border-blue-600/50 duration-200 p-4 rounded-lg group'>
            ...
            <div className='cursor-pointer bg-white/90 hover:bg-white border border-gray-200/50 hover:border-green-600/50 duration-200 p-4 rounded-lg group'>
