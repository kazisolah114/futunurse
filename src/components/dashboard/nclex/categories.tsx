            ...
            <div className='space-y-5'>
                {
                    nclexCategories.map((category, idx) => <div key={idx} className='bg-white border border-gray-200/30 rounded-lg p-5'>
                        <div className='flex items-center gap-4 mb-5'>
                            <div className='bg-teal-600/20 text-teal-600 w-11 h-11 rounded-lg flex items-center justify-center'>
                                <Stethoscope size={21} />
                            </div>
                            <div>
                                <h2 className='font-semibold text-lg text-gray-900 mb-0.5'>{category.name}</h2>
                        ...
                        <div>
                            <div className='flex items-center justify-between'>
                                ...
                                <p className={`text-sm font-medium w-16 py-0.5 text-center rounded-full ${100 >= 70 ? 'bg-green-500/20 text-green-700' : 50 >= 40 ? 'bg-yellow-500/20 text-yellow-700' : 'bg-red-100 text-red-500'}`}>50%</p>
                            </div>
                        ...
                        <div className='mt-5 flex gap-4'>
                            <Button size={'lg'} className='flex-1'><PlayIcon /> Start Session</Button>
                            <Button size={'lg'} variant={'secondary'} className='w-44'><BookA /> Study Guide</Button>
                        </div>
                    </div>
                    )
                }
