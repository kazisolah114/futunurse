        ...
        <div>
            ...
            {currentStage === 1 ?
                (
                    ...
                    //         <TabsTrigger value={"manual"} className='w-44 py-5 text-sm cursor-pointer'>Manual Entry</TabsTrigger>
                    //         <TabsTrigger value={"template"} className='w-44 py-5 text-sm cursor-pointer'>Use Template</TabsTrigger>
                    //     </TabsList>
